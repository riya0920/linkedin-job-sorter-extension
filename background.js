...
const SYSTEM_PROMPT = [
  ...
  '   requires US citizenship, a security/government clearance, "must be authorized to work without',
  '   sponsorship", "must not require sponsorship now or in the future", "authorized to work for any',
  '   employer", or anything equivalent; OR you are genuinely confident the company does not and has not',
  '   sponsored H-1B. This rule OVERRIDES rule 2: if the job description contains such wording, answer',
  '   "no" even when the company is a famous H-1B sponsor - this specific role is still blocked.',
